...
String serverName = "192.168.84.26";   // REPLACE WITH YOUR Raspberry Pi IP ADDRESS
...
void calcURLs() {
    // Set the URL's
        ...
        sprintf(streamURL, "http://cameras.beehivemonitoringscu.lol");
    #else
...
if (timeinfo.tm_hour >= 8 && timeinfo.tm_hour <= 19) {
    //if(timeinfo.tm_min >= 15 && timeinfo.tm_min <= 49) {
...
//
  //else {
    //Serial.print("System is sleeping!");
